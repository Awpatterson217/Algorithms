...
<br /><br /><pre>
Given the dataset: [{1:5},{2:9},{3:4},{4:5},{5:5},{6:9},{7:4},{8:5},{9:9},{10:4},{11:5},{12:9},{13:4},
...
<br />
2: 5+9+4+5+5+6+4+5+9+4+5 = 65. <br />
The algorithm stops at the eleventh hour, because adding the value of the 12th hour(9) to the partial sum would mean the partial sum would equal a number greater than 66.
<br />
3: Return 11. 
<br />
<hr>
